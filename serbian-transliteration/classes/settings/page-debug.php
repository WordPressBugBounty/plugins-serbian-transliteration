...
<div class="accordion-container">
	...
	<div class="accordion-panel" style="padding:0;">
		<table class="rstr-debug-table" style="width:100%; max-width:100%; text-align:left; border-collapse: collapse">
			<tr>
				<th style="width:35%;min-width: 165px;border: 1px solid #efefef; padding: 8px;"><?php _e('Option name', 'serbian-transliteration'); ?></th>
				<th style="border: 1px solid #efefef; padding: 8px;"><?php _e('Value', 'serbian-transliteration'); ?></th>
			</tr>
			...
			<tr>
				...
				<?php if(is_array($val)) : ?>
					<table class="rstr-debug-table-iner" style="width:100%; max-width:100%; text-align:left; padding:0; margin:0; border-collapse: collapse;">
						<tr>
							<th style="width:50%;border: 1px solid #efefef; padding: 8px;"><?php _e('Key', 'serbian-transliteration'); ?></th>
							<th style="border: 1px solid #efefef; padding: 8px;"><?php _e('Value', 'serbian-transliteration'); ?></th>
						</tr>
